...
import ru.bootjava.vote.to.UserTo;
import ru.bootjava.vote.util.JsonUtil;
import ru.bootjava.vote.util.UsersUtil;
...
import static ru.bootjava.vote.web.user.ProfileController.REST_URL;
import static ru.bootjava.vote.web.user.UserTestData.*;
