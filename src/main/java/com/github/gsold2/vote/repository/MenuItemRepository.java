...
public interface MenuItemRepository extends BaseRepository<MenuItem> {
    ...
    @Query("SELECT m FROM MenuItem m JOIN FETCH m.dish JOIN FETCH m.dish.restaurant WHERE m.dateOfMenu = :date AND m.dish.restaurant.user.id = :userId AND m.dish.restaurant.id=:restaurantId")
